	...
	if (req.method === 'POST') {
		...
		res.status(200).json({
			...
			result: {
				user: "gods",
				accessToken: {
					token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJnb2RzIiwiaWF0IjoxNjU4NDAwMjM2LCJleHAiOjE2NTg0ODY2MzZ9.YdWnkmRdj9xEcPxgUM2_UBDsXngOTkQQOX-szT18CQU",
					expiresIn: "24h"
				}
			}
		});
